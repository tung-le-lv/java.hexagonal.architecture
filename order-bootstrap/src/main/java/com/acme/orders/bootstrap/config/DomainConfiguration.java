 ...
 *
 * <p>Configuration, not business logic: the {@code IDiscountPolicy} implementations live in the domain,
...
public class DomainConfiguration {
    ...
    @Bean
    IDiscountPolicy discountPolicy(OrderProperties properties) {
