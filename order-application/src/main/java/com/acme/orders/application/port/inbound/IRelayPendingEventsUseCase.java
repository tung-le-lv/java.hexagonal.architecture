...
/**
 * Input port: pushes recorded-but-undelivered events out to the broker.
 *
 ...
 * a scheduler, a queue worker, an admin endpoint, a test — is then just another inbound adapter.
 */
