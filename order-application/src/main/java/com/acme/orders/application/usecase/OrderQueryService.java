 ...
 */
public class OrderQueryService implements IGetOrderQuery, IListCustomerOrdersQuery {

    private static final int MAX_PAGE_SIZE = 100;

    private final IOrderQueryRepository orderQueries;

    public OrderQueryService(IOrderQueryRepository orderQueries) {
